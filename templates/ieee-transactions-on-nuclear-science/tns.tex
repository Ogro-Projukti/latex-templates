...
Science} \newline (Jan 2025)}
\begin{document}
\title{Preparation of Papers for Review by the \textsc{IEEE Transactions on Nuclear
Science} \\ (Jan 2025)}
...
for preparing papers for \textsc{IEEE Transactions on Nuclear
Science}. Use this document as a template if you
