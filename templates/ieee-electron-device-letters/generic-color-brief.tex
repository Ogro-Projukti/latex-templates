\documentclass[twoside,web]{ieeecolor}
\usepackage{generic}
\usepackage{cite}
...
\begin{document}
\title{Preparation of Brief Papers for IEEE TRANSACTIONS and JOURNALS (February 2017)}
...
{http://www.ieee.org/organizations/pubs/ani\_prod/}\discretionary{}{}{}\underline
{keywrd98.txt}
\end{IEEEkeywords}
