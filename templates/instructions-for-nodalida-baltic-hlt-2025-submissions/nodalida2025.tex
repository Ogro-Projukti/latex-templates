...
NoDaLiDa proceedings by Mark Fishel (NoDaLiDa 2023), Lilja Øvrelid (NoDaLiDa 2021), Barbara Plank and Mareike Hartmann (NoDaLiDa 2019), Be\'{a}ta Megyesi (NoDaLiDa 2017 and 2015), which are
...
rejected without review. Note that we do not allow any additional pages for appendices in submitted papers. 

Final versions of accepted papers will be given one additional page of content (up to 9 pages for long papers, up to 5 pages for short papers and demo papers) to address reviewers’ comments. For camera-ready papers, we allow additional pages for appendices, as well as for ethical considerations, limitations, and acknowledgments.
