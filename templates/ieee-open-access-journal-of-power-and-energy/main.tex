...
\def\OJlogo{\vspace{-14pt}\includegraphics[height=28pt]{PES-logo.png}}
\begin{document}
...
%\doiinfo{OAJPE.2023.1234567}

\title{Preparation of Papers for IEEE PES JOURNALS}
...
\markboth{Preparation of Papers for IEEE PES JOURNALS}{Author \textit{et al.}}
...
electronic file from the PES Author's Kit at \underline
{https://ieee-pes.org/publications/authors-kit/} so you can use it to prepare your manuscript.
...
If your paper is intended for a conference, please contact your conference editor concerning acceptable formats for your particular conference. Please observe the conference page limits.

IEEE will do the final formatting of your paper if it is accepted for publication in a PES journal.
...
A general IEEE styleguide is available at \href{https://newauthors.ieeeauthorcenter.ieee.org/author-tools/}{\underline{https://newauthors.ieeeauthorcenter.ieee.org/author-tools/}}.
...
following Open Type fonts: Times New Roman, Helvetica, Arial, Cambria, and Symbol. If you are supplying EPS, PS, or PDF files all fonts must be 
...
compliance with IEEE Journals standards before submission. The online 
...
that they are named according to the IEEE Journals naming convention. 
...
column. In addition to, or even in lieu of submitting figures 
...
When you submit your final version (after your paper has been accepted), follow the instructions in the acceptance letter.
...
system, ScholarOne{\textregistered} Manuscripts. The url for the PES Journals review sites is \underline{https://mc.manuscriptcentral.com/pes-ieee}. 
 First 
...
require that final submissions be uploaded through ScholarOne Manuscripts. Final 
...
visit the IEEE Intellectual Property Rights department web page at \href{http://www.ieee.org/publications_standards/publications/rights/index.html}{
\underline{http://www.ieee.org/publications\_standards/publications/rig-}}
\href{http://www.ieee.org/publications_standards/publications/rights/index.html}{\underline{hts/index.html}}
...
The IEEE Journals Department strongly discourages courtesy authorship; 
...
The two types of contents that are published are: 1) peer-reviewed and 2) 
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{Tesla.png}}]{Nikola Tesla }(M’1888, F’17) was born in Smiljan in the Austro-Hungarian Empire, on July 9, 1856. He graduated from the Austrian Polytechnic School, Graz, and studied at the University of Prague.
