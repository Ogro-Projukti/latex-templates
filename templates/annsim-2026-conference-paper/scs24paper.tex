...
\usepackage[colorlinks=true,urlcolor=blue,citecolor=black,anchorcolor=black,linkcolor=black,bookmarks=false]{hyperref}
...
\author[\authorrefmark{1}]{Román Cárdenas}
\author[\authorrefmark{2}]{Bentley James Oakes}
\author[\authorrefmark{3}]{Ahmad Bany Abdelnabi}

% Department and university with the mark
\affil[\authorrefmark{1}]{Integrated Systems Laboratory, Universidad Politécnica de Madrid, Spain}
...
\affil[\authorrefmark{3}]{School of Modeling, Simulation, and Training, University of Central Florida, USA}
