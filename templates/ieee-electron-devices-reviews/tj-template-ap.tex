...
Immediately after you have submitted your final files through IEEE Author Portal you will be automatically redirected to the IEEE electronic copyright form wizard. Please complete the copyright at that time to avoid publication delays. 
...
{FIRST A. AUTHOR}~(Fellow, IEEE)~and all authors may include 100-word biographies. Please check the Information for Authors to confirm. Author’s passport size photos should be current, professional images of the head and shoulders. Include the author’s educational background listing the last degree, type of degree in what field, institution, city, state, and country, and year the degree was earned. The author’s major field of study should be lowercase. Using the preferred third person pronoun (he, she, they, etc.) and not the author’s last name, list only author’s current job, capitalized job title, and location. Finally, information concerning previous publications as well as awards and recognition may be included within 100-word limit. The format for listing publishers of a book within the biography is: Title of Book (publisher name, year) similar to a reference. 
\end{IEEEbiography}
