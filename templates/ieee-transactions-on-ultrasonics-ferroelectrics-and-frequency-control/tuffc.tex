...
\usepackage{graphicx}
\usepackage{textcomp}
\usepackage{wrapfig,colortbl}
\definecolor{abstractbg}{rgb}{1,0.969,0.914}
\setlength{\fboxrule}{0pt}
\setlength{\fboxsep}{0pt}
\def\BibTeX{{\rm B\kern-.05em{\sc i\kern-.025em b}\kern-.08em
    T\kern-.1667em\lower.7ex\hbox{E}\kern-.125emX}}
\markboth{\journalname, VOL. XX, NO. XX, XXXX 2017}
{Author \MakeLowercase{\textit{et al.}}: Preparation of Papers for IEEE TRANSACTIONS on Ultrasonics, Ferrolectrics, and Frequency Control}
\begin{document}
\title{Preparation of Papers for IEEE TRANSACTIONS on Ultrasonics, Ferrolectrics, and Frequency Control}
...
\begin{minipage}{\textwidth}\rightskip2em\leftskip\rightskip\bigskip
\begin{wrapfigure}[15]{r}{3in}%
\hspace{-3pc}\includegraphics[width=2.9in]{tuffcga.png}
\end{wrapfigure}%
\begin{abstract}
...
{http://www.ieee.org/}\discretionary{}{}{}\underline{organizations/}\discretionary{}{}{}\underline{pubs/}\discretionary{}{}{}\underline{ani\_prod/}\discretionary{}{}{}\underline{keywrd98.txt}
\end{IEEEkeywords}
\bigskip
\end{minipage}}}
...
\begin{table*}[!t]
\arrayrulecolor{subsectioncolor}
\setlength{\arrayrulewidth}{1pt}
{\sffamily\bfseries\begin{tabular}{lp{6.75in}}\hline
\rowcolor{abstractbg}\multicolumn{2}{l}{\color{subsectioncolor}{\itshape
Highlights}{\Huge\strut}}\\
\rowcolor{abstractbg}$\bullet$ & Please provide three point-form
statements that summarize your article. One statement should
summarize the most significant element of novelty in the presented
work.\\
\rowcolor{abstractbg}$\bullet${\large\strut} & One statement should provide an
executive summary on the main results of this paper.\\
\rowcolor{abstractbg}$\bullet${\large\strut} & One statement should highlight the
implications and importance of the reported findings to the research
field. Each point-form statement should contain no more than 200
characters.\\[2em]\hline
\end{tabular}}
...
The image should be placed in the graphical abstract box on the front
page of the manuscript. It should have a physical size of no larger
than 3.3''(width) x 4.4'' (height). The image resolution should be at
least 300 dpi. The graphical abstract may be an image of your most
representative result(s), an illustration of the methodological
innovation, or a combination of both. Labels may be included within
the figure, but please do not include captions or subfigure labels
such as (a), (b), (c), etc. If labels are to be included, they should
be in Arial font. The image background color should be white.
